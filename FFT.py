    ...
    for i in path.mix_subject:
        for j in path.mix_char2:
            for l in path.time:
                ...
                nf = open(path.fft_mix + "/" + d + "/" + i + "/" + j + "/" + l + "fft.CSV", 'w')
                ...
                new_data.to_csv(path.fft_mix + "/" + d + "/" + i + "/" + j + "/" + l + "fft.CSV")
                print("fft/" + "/" + d + "/" + i + "/" + j  + "/" + l + "fft.CSV")
...
x2 = np.linspace(0,len(c_f_ch0),len(c_f_ch0))
plt.plot(x2/2, c_f_ch0, c="r", alpha=0.7, label='filtered')
print(len(c_f_ch0_p)/2)
plt.show()
