    ...
    for i in path.subject:
        for j in path.char:
            for o in path.cut4_time:
                for l in path.time:
                    file_path = path.cut4 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "cut.CSV"
                    ...
                    nf = open(path.fft_4 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "fft.CSV", 'w')
                    ...
                    c_f_ch0_p = pd.DataFrame(c_f_ch0.real)
                    c_f_ch1_p = pd.DataFrame(c_f_ch1.real)
                    c_f_ch2_p = pd.DataFrame(c_f_ch2.real)
                    c_f_ch3_p = pd.DataFrame(c_f_ch3.real)
                    c_f_ch4_p = pd.DataFrame(c_f_ch4.real)
                    c_f_ch5_p = pd.DataFrame(c_f_ch5.real)
                    c_f_ch6_p = pd.DataFrame(c_f_ch6.real)
                    ...
                    new_data = new_data.iloc[1:258, 1:7]

                    new_data.to_csv(path.fft_4 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "fft.CSV")
...
x2 = np.linspace(0,len(c_F_ch0_abs_amp),len(c_F_ch0_abs_amp))
plt.plot(x2, c_F_ch0_abs_amp, c="r", alpha=0.7, label='filtered')
