        ...
        for s in path.sets_test:
            for j in path.mix_char2:
                for o in path.cutplusmix_time:
                    for l in path.time:
                        file_path = path.cut_plusmix_twoPole + "/" + i + "/" + d + "/" + s + "/" + j + "/" + o + "/" + l + "cut.CSV"
                        ...
                        nf = open(path.fft_mix_15_twoPole + "/" + i + "/" + d + "/" + s + "/" + j + "/" + o + "/" + l + "fft.CSV", 'w')
                        ...
                        new_data.to_csv(path.fft_mix_15_twoPole + "/" + i + "/" + d + "/" + s + "/" + j + "/" + o + "/" + l + "fft.CSV")
