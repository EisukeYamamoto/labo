        ...
        for j in path.char:
            for o in path.cut8_time:
                for l in path.time:
                    ...
                    nf = open(path.ifft_8 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "ifft.CSV", 'w')
                    ...
                    new_data.to_csv(path.ifft_8 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "ifft.CSV")
                    print("ifft/" + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "ifft.CSV")
...
plt.plot(x2,ch0,label='original')
plt.plot(x2,c_f_ch0_ifft_real/2 , c='r', linewidth=4, alpha=0.7)
