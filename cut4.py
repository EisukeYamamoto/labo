        ...
        for j in path.char:
            for l in path.time:
                ...
                for o in path.cut4_time:
                    nf = open(path.cut8 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "cut.CSV", 'w')
                    ...
                    y1 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    y2 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    y3 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    y4 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    y5 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    y6 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    y7 = df.iloc[int((N / 4) * o2):int((N / 4) * (o2+1)),:]
                    ...
                    new_data.to_csv(path.cut4 + "/" + d + "/" + i + "/" + j + "/" + o + "/" + l + "cut.CSV")
