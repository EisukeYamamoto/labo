...
debug = 1  # 0:プロット無し, 1:各チャンネルごとの分離比較, 2:チャンネルを一式表示, 3:一式表示
plot_flg = 1  # 0:保存しない, 1:保存する
fft_flg = 2 # 0:時系列データ, 1:パワースペクトル
...
def plot_mixture_sources_predictions(X, original_sources, S, ch):
    ...
    if plot_flg == 1:
        if x_flg == 1:
            ...
            plotpath1 = path.png_ica + "/" + d + "/" + i + "/" + "fastICA+JADE" + "/各チャンネルの比較/" + str(ch) + "ch"
        elif x_flg == 2:
...
def mapping_1(ch_list1, ch_list2):
    ...
    # new_ch_list_0 = [y0_0, y0_1, y0_2, y0_3, y0_4, y0_5, y0_6] #
    # new_ch_list_1 = [y1_0, y1_1, y1_2, y1_3, y1_4, y1_5, y1_6] #
...
def write_plot(ch_list, name):
    ...
    if plot_flg == 1:
        if x_flg == 1:
            ...
            plotpath2 = path.png_ica + "/" + d + "/" + i + "/" + "fastICA+JADE" + "/" + name
        elif x_flg == 2:
...
# S_0_ch_list = [S0[0], S1[0], S2[0], S3[0], S4[0], S5[0], S6[0]] #
# S_1_ch_list = [S0[1], S1[1], S2[1], S3[1], S4[1], S5[1], S6[1]] #
# X_0_ch_list = [X0[0], X1[0], X2[0], X3[0], X4[0], X5[0], X6[0]] #
# X_1_ch_list = [X0[1], X1[1], X2[1], X3[1], X4[1], X5[1], X6[1]] #
# S_ch_list = [S0, S1, S2, S3, S4, S5, S6] #
# X_ch_list = [X0, X1, X2, X3, X4, X5, X6] #
#
#
# tekubi_ch_list_abs = [abs(tekubi_ch0)**2, abs(tekubi_ch1)**2, abs(tekubi_ch2)**2, abs(tekubi_ch3)**2, #
#                       abs(tekubi_ch4)**2, abs(tekubi_ch5)**2, abs(tekubi_ch6)**2] #
# yubi_ch_list_abs = [abs(yubi_ch0)**2, abs(yubi_ch1)**2, abs(yubi_ch2)**2, abs(yubi_ch3)**2, #
#                     abs(yubi_ch4)**2, abs(yubi_ch5)**2, abs(yubi_ch6)**2] #
# mix_ch_list_abs = [abs(mix_ch0)**2, abs(mix_ch1)**2, abs(mix_ch2)**2, abs(mix_ch3)**2, #
#                    abs(mix_ch4)**2, abs(mix_ch5)**2, abs(mix_ch6)**2] #
...
# yubi_var = [y_0v, y_1v, y_2v, y_3v, y_4v, y_5v, y_6v] #
...
# tekubi_var = [t_0v, t_1v, t_2v, t_3v, t_4v, t_5v, t_6v] #
...
# S0_var = [S0_0v, S0_1v, S0_2v, S0_3v, S0_4v, S0_5v, S0_6v] #
...
# S1_var = [S1_0v, S1_1v, S1_2v, S1_3v, S1_4v, S1_5v, S1_6v] #
...
# Mix_var = [Mix_0v, Mix_1v, Mix_2v, Mix_3v, Mix_4v, Mix_5v, Mix_6v] #
...
if clf_flg == 1:
    ...
    clf0.fit(S_ch_0, mix_[0])
    print(clf0.coef_)
    b0_0 = (clf0.coef_[0] * ((S0_0v / Mix_0v) ** 0.5)) ** 2
    b0_1 = (clf0.coef_[1] * ((S1_0v / Mix_0v) ** 0.5)) ** 2
    ren0 = sim_pearson(S_ch_0[0], mix_[0])
    ren0_1 = sim_pearson(S_ch_0[1], mix_[0])
    score0 = clf0.score(S_ch_0, mix_[0])
    if b0_0 > b0_1:
        s_t0 = S_ch_0[0]
        s_y0 = S_ch_0[1]
    else:
    ...
    clf0.fit(S_ch_0, yubi[0])
    print(clf0.coef_)
    b0_0 = (clf0.coef_[0] * ((S0_0v / y_0v) ** 0.5)) ** 2
    b0_1 = (clf0.coef_[1] * ((S1_0v / y_0v) ** 0.5)) ** 2
    ren0 = sim_pearson(S_ch_0[0], yubi[0])
    ren0_1 = sim_pearson(S_ch_0[1], yubi[0])
    score0 = clf0.score(S_ch_0, yubi[0])
    if b0_0 > b0_1:
        s_t0 = S_ch_0[0]
        s_y0 = S_ch_0[1]
    else:
...
if clf_flg == 1:
    ...
    clf1.fit(S_ch_1, mix_[1])
    print(clf1.coef_)
    b1_0 = (clf1.coef_[0] * ((S0_1v / Mix_1v) ** 0.5)) ** 2
    b1_1 = (clf1.coef_[1] * ((S1_1v / Mix_1v) ** 0.5)) ** 2
    ren1 = sim_pearson(S_ch_1[0], mix_[1])
    ren1_1 = sim_pearson(S_ch_1[1], mix_[1])
    score1 = clf1.score(S_ch_1, mix_[1])
    if b1_0 > b1_1:
        s_t1 = S_ch_1[0]
        s_y1 = S_ch_1[1]
    else:
    ...
    clf1.fit(S_ch_1, yubi[1])
    print(clf1.coef_)
    b1_0 = (clf1.coef_[0] * ((S0_1v / y_1v) ** 0.5)) ** 2
    b1_1 = (clf1.coef_[1] * ((S1_1v / y_1v) ** 0.5)) ** 2
    ren1 = sim_pearson(S_ch_1[0], yubi[1])
    ren1_1 = sim_pearson(S_ch_1[1], yubi[1])
    score1 = clf1.score(S_ch_1, yubi[1])
    if b1_0 > b1_1:
        s_t1 = S_ch_1[0]
        s_y1 = S_ch_1[1]
    else:
...
if clf_flg == 1:
    ...
    clf2.fit(S_ch_2, mix_[2])
    print(clf2.coef_)
    b2_0 = (clf2.coef_[0] * ((S0_2v / Mix_2v) ** 0.5)) ** 2
    b2_1 = (clf2.coef_[1] * ((S1_2v / Mix_2v) ** 0.5)) ** 2
    ren2 = sim_pearson(S_ch_2[0], mix_[2])
    ren2_1 = sim_pearson(S_ch_2[1], mix_[2])
    score2 = clf2.score(S_ch_2, mix_[2])
    if b2_0 > b2_1:
        s_t2 = S_ch_2[0]
        s_y2 = S_ch_2[1]
    else:
    ...
    clf2.fit(S_ch_2, yubi[2])
    print(clf2.coef_)
    b2_0 = (clf2.coef_[0] * ((S0_2v / y_2v) ** 0.5)) ** 2
    b2_1 = (clf2.coef_[1] * ((S1_2v / y_2v) ** 0.5)) ** 2
    ren2 = sim_pearson(S_ch_2[0], yubi[2])
    ren2_1 = sim_pearson(S_ch_2[1], yubi[2])
    score2 = clf2.score(S_ch_2, yubi[2])
    if b2_0 > b2_1:
        s_t2 = S_ch_2[0]
        s_y2 = S_ch_2[1]
    else:
...
if clf_flg == 1:
    ...
    clf3.fit(S_ch_3, mix_[3])
    print(clf3.coef_)
    b3_0 = (clf3.coef_[0] * ((S0_3v / Mix_3v) ** 0.5)) ** 2
    b3_1 = (clf3.coef_[1] * ((S1_3v / Mix_3v) ** 0.5)) ** 2
    ren3 = sim_pearson(S_ch_3[0], mix_[3])
    ren3_1 = sim_pearson(S_ch_3[1], mix_[3])
    score3 = clf3.score(S_ch_3, mix_[3])
    if b3_0 > b3_1:
        s_t3 = S_ch_3[0]
        s_y3 = S_ch_3[1]
    else:
    ...
    clf3.fit(S_ch_3, yubi[3])
    print(clf3.coef_)
    b3_0 = (clf3.coef_[0] * ((S0_3v / y_3v) ** 0.5)) ** 2
    b3_1 = (clf3.coef_[1] * ((S1_3v / y_3v) ** 0.5)) ** 2
    ren3 = sim_pearson(S_ch_3[0], yubi[3])
    ren3_1 = sim_pearson(S_ch_3[1], yubi[3])
    score3 = clf3.score(S_ch_3, yubi[3])
    if b3_0 > b3_1:
        s_t3 = S_ch_3[0]
        s_y3 = S_ch_3[1]
    else:
...
#
# elif clf_flg == 2:
#     clf4.fit(S_ch_4, mix_[4])
#     print(clf4.coef_)
#     b4_0 = (clf4.coef_[0] * ((S0_4v / Mix_4v) ** 0.5)) ** 2
#     b4_1 = (clf4.coef_[1] * ((S1_4v / Mix_4v) ** 0.5)) ** 2
#     ren4 = sim_pearson(S_ch_4[0], mix_[4])
#     ren4_1 = sim_pearson(S_ch_4[1], mix_[4])
#     score4 = clf4.score(S_ch_4, mix_[4])
#     if b4_0 > b4_1:
#         s_t4 = S_ch_4[0]
#         s_y4 = S_ch_4[1]
#     else:
...
#     clf4.fit(S_ch_4, yubi[4])
#     print(clf4.coef_)
#     b4_0 = (clf4.coef_[0] * ((S0_4v / y_4v) ** 0.5)) ** 2
#     b4_1 = (clf4.coef_[1] * ((S1_4v / y_4v) ** 0.5)) ** 2
#     ren4 = sim_pearson(S_ch_4[0], yubi[4])
#     ren4_1 = sim_pearson(S_ch_4[1], yubi[4])
#     score4 = clf4.score(S_ch_4, yubi[4])
#     if abs(ren4) > abs(ren4_1):
#         s_t4 = S_ch_4[0]
#         s_y4 = S_ch_4[1]
#     else:
#         s_t4 = S_ch_4[1]
...
#
# elif clf_flg == 2:
#     clf5.fit(S_ch_5, mix_[5])
#     print(clf5.coef_)
#     b5_0 = (clf5.coef_[0] * ((S0_5v / Mix_5v) ** 0.5)) ** 2
#     b5_1 = (clf5.coef_[1] * ((S1_5v / Mix_5v) ** 0.5)) ** 2
#     ren5 = sim_pearson(S_ch_5[0], mix_[5])
#     ren5_1 = sim_pearson(S_ch_5[1], mix_[5])
#     score5 = clf5.score(S_ch_5, mix_[5])
#     if b5_0 > b5_1:
#         s_t5 = S_ch_5[0]
#         s_y5 = S_ch_5[1]
#     else:
...
#     clf5.fit(S_ch_5, yubi[5])
#     print(clf5.coef_)
#     b5_0 = (clf5.coef_[0] * ((S0_5v / y_5v) ** 0.5)) ** 2
#     b5_1 = (clf5.coef_[1] * ((S1_5v / y_5v) ** 0.5)) ** 2
#     ren5 = sim_pearson(S_ch_5[0], yubi[5])
#     ren5_1 = sim_pearson(S_ch_5[1], yubi[5])
#     score5 = clf5.score(S_ch_5, yubi[5])
#     if b5_0 > b5_1:
#         s_t5 = S_ch_5[0]
#         s_y5 = S_ch_5[1]
#     else:
...
#
# elif clf_flg == 2:
#     clf6.fit(S_ch_6, mix_[6])
#     print(clf6.coef_)
#     b6_0 = (clf6.coef_[0] * ((S0_6v / Mix_6v) ** 0.5)) ** 2
#     b6_1 = (clf6.coef_[1] * ((S1_6v / Mix_6v) ** 0.5)) ** 2
#     ren6 = sim_pearson(S_ch_6[0], mix_[6])
#     ren6_1 = sim_pearson(S_ch_6[1], mix_[6])
#     score6 = clf6.score(S_ch_6, mix_[6])
#     if b6_0 > b6_1:
#         s_t6 = S_ch_6[0]
#         s_y6 = S_ch_6[1]
#     else:
...
#     clf6.fit(S_ch_6, yubi[6])
#     print(clf6.coef_)
#     b6_0 = (clf6.coef_[0] * ((S0_6v / y_6v) ** 0.5)) ** 2
#     b6_1 = (clf6.coef_[1] * ((S1_6v / y_6v) ** 0.5)) ** 2
#     ren6 = sim_pearson(S_ch_6[0], yubi[6])
#     ren6_1 = sim_pearson(S_ch_6[1], yubi[6])
#     score6 = clf6.score(S_ch_6, yubi[6])
#     if b6_0 > b6_1:
#         s_t6 = S_ch_6[0]
#         s_y6 = S_ch_6[1]
#     else:
...
nf = open(path.png_ica + "/" + d + "/" + i + "/" + "fastICA+JADE" + "/" + "結果_fastICA+JADE.CSV", 'w', encoding="utf_8_sig")
...
# s_tekubi_list = [s_t0, s_t1, s_t2, s_t3, s_t4, s_t5, s_t6] #
# s_yubi_list = [s_y0, s_y1, s_y2, s_y3, s_y4, s_y5, s_y6] #
