...
def plot_mixture_sources_predictions(X, original_sources, S, ch):
    ...
    if plot_flg == 1:
        if x_flg == 1:
            ...
            plotpath1 = path.png_ica_abs + "/" + i + "/" + d + "/" + s + "/" + l + "/" + c + "/JADE+fastICA/各チャンネルの比較/" + str(
                ch) + "ch"
        elif x_flg == 2:
...
def write_plot(ch_list, name):
    ...
    if plot_flg == 1:
        if x_flg == 1:
            ...
            plotpath2 = path.png_ica_abs + "/" + i + "/" + d + "/" + s + "/" + l + "/" + c + "/JADE+fastICA/" + name
        elif x_flg == 2:
...
nf_all = open(path.png_ica_abs + "/" + "結果まとめ_JADE+fastICA.CSV", 'w', encoding="utf_8_sig")
        ...
        for s in path.sets:
            ...
            for l in path.time:
                ...
                for c in path.cut8_time:
                    ...
                    print("////////////////////////////////////////////////////////")
                    print()
                    nf = open(path.png_ica_abs + "/" + i + "/" + d + "/" + s + "/" + l + "/" + c + "/JADE+fastICA/結果_JADE+fastICA.CSV", 'w',
                              encoding="utf_8_sig")
