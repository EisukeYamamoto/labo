...
def write_plot(ch_list, d, i, j, l, df):
    ...
    plt.plot(x, yo0, color="b")
    plt.plot(x, yo1, color="r")
    plt.plot(x, yo2, color="g")
    plt.plot(x, yo3, color="c")
    plt.plot(x, yo4, color="m")
    plt.plot(x, yo5, color="y")
    plt.plot(x, yo6, color="k")
        ...
        for i in path.mix_subject:
            for j in path.yubi_only:
                # for o in path.cut_time:
                    for l in path.times:
                        file_path = path.fft_mix + "/" + d + "/" + i + "/" + j + "/" + l + "fft.CSV"
