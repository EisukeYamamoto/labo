            ...
            for j in path.mix_char2:
                ...
                for l in path.time:
                    ...
                    for o in path.cutplusmix_time:
                        file_path = path.fft_mix_15_twoPole + "/" + i + "/" + d + "/" + s + "/" + j + "/" + o + "/" + l + "fft.CSV"
                ...
                nf = open(path.plus_avarage_fft_twoPole + "/" + i + "/" + d + "/" + s  + "/" + j + "/" + l + "fft.CSV", 'w')
                ...
                new_data.to_csv(path.plus_avarage_fft_twoPole + "/" + i + "/" + d + "/" + s + "/" + j + "/" + l + "fft.CSV")
